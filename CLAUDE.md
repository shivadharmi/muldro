...
refactoring process (characterization tests, structure/behavior commit separation), the
view-layer side-effect rule, and OSS hygiene. Read it before structural changes. Summary below.

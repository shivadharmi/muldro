        ...
        >
          <div className="flex items-center gap-2 shrink-0 border-b border-b-secondary py-[14px] pl-[8px] pr-[12px] sm:px-6 sm:py-4">
            <button
              ...
              className="sm:hidden flex items-center gap-0.5 h-[44px] px-[8px] text-[15px] text-j-primary rounded-[var(--radius-md)] hover:bg-surface-2 transition-colors cursor-pointer"
            >
              <ChevronLeft />
              Settings
            </button>
            ...
            <button
              onClick={closeSettings}
              className="shrink-0 flex items-center justify-center h-[44px] w-[44px] sm:h-auto sm:w-auto sm:p-1 rounded-[var(--radius-sm)] text-t-muted hover:text-t-primary hover:bg-surface-2 transition-colors cursor-pointer"

...
test("the rail lists all eight tabs", () => {
  // The count is hardcoded on purpose. The labels are derived from SETTINGS_TABS,
  // so they follow it wherever it goes — only the number makes adding or losing a
  // tab a deliberate act rather than a silent one.
  render(<SettingsModal />);

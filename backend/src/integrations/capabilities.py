...
TOOL_TO_CAPABILITY: dict[str, str] = {
    ...
    # Google Workspace MCP — live-verified 2026-03-30
    "search_gmail_messages": "email.search",
    "get_gmail_message_content": "email.read",
    "get_gmail_messages_content_batch": "email.read",
    "send_gmail_message": "email.send",
    "draft_gmail_message": "email.draft",
    "modify_gmail_message_labels": "email.send",
    "batch_modify_gmail_message_labels": "email.send",
    "get_gmail_thread_content": "email.read",
    "get_gmail_threads_content_batch": "email.read",
    "get_gmail_attachment_content": "email.read",
    "list_gmail_labels": "email.list",
    "list_gmail_filters": "email.list",
    "manage_gmail_filter": "email.send",
    "manage_gmail_label": "email.send",
    "get_events": "calendar.list",
    "list_calendars": "calendar.list",
    "manage_event": "calendar.create",
    "query_freebusy": "calendar.get",
    # Calendar native
